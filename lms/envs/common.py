...
SAML_CONFIG = {
    ...
    'entityid': 'http://preview.localhost:8000/',
        ...
        'sp': {
            ...
            'endpoints': {
                ...
                'assertion_consumer_service': [
                    ('http://preview.localhost:8000/saml2/acs/',
                     saml2.BINDING_HTTP_POST),
                ],
                'single_logout_service': [
                    ('http://preview.localhost:8000/saml2/ls/',
                     saml2.BINDING_HTTP_REDIRECT),
                    ('http://preview.localhost:8000/saml2/ls/post',
                     saml2.BINDING_HTTP_POST), ], },
            ...
            #     'http://wqu.edvera.dev:3000/single_signon/saml2/metadata': {
            #         'single_sign_on_service': {
            #             saml2.BINDING_HTTP_REDIRECT: 'http://wqu.edvera.dev:3000/single_signon/saml2/auth',
            #         },
            #         'single_logout_service': {
            #             saml2.BINDING_HTTP_REDIRECT: 'http://wqu.edvera.dev:3000/canvas_integration/on_logout',
            #         },
            #     },
            # },
        },
    ...
    # certificate generated by this tutorial http://www.akadia.com/services/ssh_test_certificate.html
    'key_file': path.join(BASEDIR, 'server.key'),  # private part
    'cert_file': path.join(BASEDIR, 'server.crt'),  # public part
