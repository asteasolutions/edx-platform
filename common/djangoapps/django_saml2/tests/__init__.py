...
from django_saml2 import views
from django_saml2.cache import OutstandingQueriesCache
from django_saml2.conf import get_config
from django_saml2.tests import conf
from django_saml2.tests.auth_response import auth_response
...
class ConfTests(TestCase):
    ...
    def test_custom_conf_loader(self):
        config_loader_path = 'django_saml2.tests.test_config_loader'
    ...
    def test_custom_conf_loader_from_view(self):
        config_loader_path = 'django_saml2.tests.test_config_loader_with_real_conf'
