...
from django_saml2.signals import pre_user_save
...
class Saml2Backend(ModelBackend):
    ...
    def authenticate(self, session_info=None, attribute_mapping=None,
        ...
        edvera_id = session_info['name_id'].text
        external_domain = session_info['issuer']

        eamap = ExternalAuthMap.objects.get(external_id=edvera_id)
